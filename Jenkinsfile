...
stages {
    ...
    stage('Jmeter test') {
         steps {
               sh "/opt/jmeter/bin/jmeter.sh -Jjmeter.save.saveservice.output_format=xml -n -t webapp/src/main/webapp/jmeter/Testing.jmx -JTOTAL_THREADS=2 -JTEST_DURATION=60 -l MyRun1.jtl"
